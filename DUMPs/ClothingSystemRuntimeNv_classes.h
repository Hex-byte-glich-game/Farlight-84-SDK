...
struct UClothingSimulationInteractorNv : UClothingSimulationInteractor {
	...
	void SetAnimDriveDamperStiffness(float InStiffness); // Function ClothingSystemRuntimeNv.ClothingSimulationInteractorNv.SetAnimDriveDamperStiffness // (NetRequest|Static|UbergraphFunction|MulticastDelegate|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317b49c0
};
