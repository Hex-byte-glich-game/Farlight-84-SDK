...
struct ABlockoutToolsParent : AActor {
	...
	void RerunConstructionScript(); // Function BlockoutToolsPlugin.BlockoutToolsParent.RerunConstructionScript // (NetReliableNetRequest|Exec|Public|Private|Protected|Delegate|NetServer|HasOutParms|HasDefaults|NetClient|DLLImport|BlueprintEvent|NetValidate) // @ game+0xffff822f3144d0c0
	void BlockoutSetMaterial(); // Function BlockoutToolsPlugin.BlockoutToolsParent.BlockoutSetMaterial // (NetReliableNetRequest|Exec|Public|Private|Protected|Delegate|NetServer|HasOutParms|HasDefaults|NetClient|DLLImport|BlueprintEvent|NetValidate) // @ game+0xffff822f3144d300
};
