...
struct AChaosSolverActor : AActor {
	...
	void SetSolverActive(bool bActive); // Function ChaosSolverEngine.ChaosSolverActor.SetSolverActive // (NetResponse|Static|NetMulticast|UbergraphFunction|Private|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317b25c0
	void SetAsCurrentWorldSolver(); // Function ChaosSolverEngine.ChaosSolverActor.SetAsCurrentWorldSolver // (NetResponse|Static|NetMulticast|UbergraphFunction|Private|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317b2ec0
};
