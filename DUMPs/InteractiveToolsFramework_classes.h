...
struct UGizmoBaseComponent : UPrimitiveComponent {
	...
	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Net|Exec|Event|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bbec0
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Net|NetReliableNetRequest|Event|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bc580
};
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform& NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Net|NetReliableEvent|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bbc80
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (NetRequest|Exec|Native|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bbec0
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (NetReliableNetRequest|Exec|Native|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bba40
	void GetTangentVectors(struct FVector& TangentXOut, struct FVector& TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Net|Exec|Native|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bbc80
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (NetReliableNetRequest|Native|MulticastDelegate|Public|Protected|HasOutParms|NetClient|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bbc80
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Net|NetReliableNetRequest|Native|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bbc80
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Net|Exec|Native|Event|NetResponse|Static|NetMulticast|UbergraphFunction|MulticastDelegate|Public|Private|Protected|HasOutParms|NetClient|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bb800
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (NetRequest|Event|UbergraphFunction|Private|Protected|Delegate|HasOutParms|NetClient|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bb5c0
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Event|UbergraphFunction|Private|Protected|Delegate|HasOutParms|NetClient|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bb800
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Net|NetReliableNetRequest|Exec|Native|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bb380
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Net|NetResponse|Static|NetMulticast|UbergraphFunction|MulticastDelegate|Public|Protected|HasOutParms|NetClient|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bb5c0
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (NetReliableNetRequest|Native|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bb5c0
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (NetRequest|Event|UbergraphFunction|Private|Protected|Delegate|HasOutParms|NetClient|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bb5c0
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D& NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Net|Event|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c88c0
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Exec|Native|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bb380
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (NetReliableNetRequest|Native|Static|NetMulticast|MulticastDelegate|Protected|Delegate|NetServer|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bb380
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (NetRequest|Event|UbergraphFunction|Private|Protected|Delegate|HasOutParms|NetClient|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317bb380
};
