...
struct UNavRelevantComponent : UActorComponent {
	...
	void SetNavigationRelevancy(bool bRelevant); // Function NavigationSystem.NavRelevantComponent.SetNavigationRelevancy // (NetReliableNative|Event|MulticastDelegate|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31613100
};
...
struct UNavModifierComponent : UNavRelevantComponent {
	...
	void SetAreaClass(struct UNavArea* NewAreaClass); // Function NavigationSystem.NavModifierComponent.SetAreaClass // (Native|Event|MulticastDelegate|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31613340
};
...
struct UNavigationPath : UObject {
	...
	bool IsValid(); // Function NavigationSystem.NavigationPath.IsValid // (Net|NetReliableExec|Native|Event|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	bool IsStringPulled(); // Function NavigationSystem.NavigationPath.IsStringPulled // (Net|NetReliableEvent|Static|Public|Private|Protected|HasOutParms|NetClient|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c88c0
	bool IsPartial(); // Function NavigationSystem.NavigationPath.IsPartial // (NetReliableExec|Native|Event|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c88c0
	float GetPathLength(); // Function NavigationSystem.NavigationPath.GetPathLength // (NetReliableNetRequest|Exec|Native|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c88c0
	float GetPathCost(); // Function NavigationSystem.NavigationPath.GetPathCost // (Net|NetRequest|Native|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c88c0
	struct FString GetDebugString(); // Function NavigationSystem.NavigationPath.GetDebugString // (Net|Native|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c88c0
	void EnableRecalculationOnInvalidation(enum class ENavigationOptionFlag DoRecalculation); // Function NavigationSystem.NavigationPath.EnableRecalculationOnInvalidation // (Net|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c88c0
	void EnableDebugDrawing(bool bShouldDrawDebugData, struct FLinearColor PathColor); // Function NavigationSystem.NavigationPath.EnableDebugDrawing // (Net|NetRequest|Exec|Native|Event|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c88c0
};
...
struct UNavigationSystemV1 : UNavigationSystemBase {
	...
	void UnregisterNavigationInvoker(struct AActor* Invoker); // Function NavigationSystem.NavigationSystemV1.UnregisterNavigationInvoker // (NetRequest|Native|Event|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c6dc0
	void SimpleMoveToLocation(struct AController* Controller, struct FVector& Goal); // Function NavigationSystem.NavigationSystemV1.SimpleMoveToLocation // (Net|Native|Event|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	void SimpleMoveToActor(struct AController* Controller, struct AActor* Goal); // Function NavigationSystem.NavigationSystemV1.SimpleMoveToActor // (Net|NetReliableNetRequest|Native|Event|MulticastDelegate|Protected|HasOutParms|NetClient|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	void SetMaxSimultaneousTileGenerationJobsCount(int32_t MaxNumberOfJobs); // Function NavigationSystem.NavigationSystemV1.SetMaxSimultaneousTileGenerationJobsCount // (Net|NetReliableNetRequest|Exec|Event|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	void SetGeometryGatheringMode(enum class ENavDataGatheringModeConfig NewMode); // Function NavigationSystem.NavigationSystemV1.SetGeometryGatheringMode // (Net|NetRequest|Exec|Event|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	void ResetMaxSimultaneousTileGenerationJobsCount(); // Function NavigationSystem.NavigationSystemV1.ResetMaxSimultaneousTileGenerationJobsCount // (Net|NetRequest|Exec|Event|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	void RegisterNavigationInvoker(struct AActor* Invoker, float TileGenerationRadius, float TileRemovalRadius); // Function NavigationSystem.NavigationSystemV1.RegisterNavigationInvoker // (Net|Exec|Event|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	struct FVector ProjectPointToNavigation(struct UObject* WorldContextObject, struct FVector& Point, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass, struct FVector QueryExtent); // Function NavigationSystem.NavigationSystemV1.ProjectPointToNavigation // (Net|Event|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	void OnNavigationBoundsUpdated(struct ANavMeshBoundsVolume* NavVolume); // Function NavigationSystem.NavigationSystemV1.OnNavigationBoundsUpdated // (Net|NetReliableNetRequest|Exec|Native|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	bool NavigationRaycast(struct UObject* WorldContextObject, struct FVector& RayStart, struct FVector& RayEnd, struct FVector& HitLocation, struct UNavigationQueryFilter* FilterClass, struct AController* Querier); // Function NavigationSystem.NavigationSystemV1.NavigationRaycast // (Net|NetReliableNetRequest|Native|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	bool K2_ReplaceAreaInOctreeData(struct UObject* Object, struct UNavArea* OldArea, struct UNavArea* NewArea); // Function NavigationSystem.NavigationSystemV1.K2_ReplaceAreaInOctreeData // (Net|NetReliableNative|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	bool K2_ProjectPointToNavigation(struct UObject* WorldContextObject, struct FVector& Point, struct FVector& ProjectedLocation, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass, struct FVector QueryExtent); // Function NavigationSystem.NavigationSystemV1.K2_ProjectPointToNavigation // (NetRequest|Exec|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	bool K2_GetRandomReachablePointInRadius(struct UObject* WorldContextObject, struct FVector& Origin, struct FVector& RandomLocation, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.K2_GetRandomReachablePointInRadius // (NetRequest|Static|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	bool K2_GetRandomPointInNavigableRadius(struct UObject* WorldContextObject, struct FVector& Origin, struct FVector& RandomLocation, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.K2_GetRandomPointInNavigableRadius // (NetRequest|Exec|Native|Event|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	bool K2_GetRandomLocationInNavigableRadius(struct UObject* WorldContextObject, struct FVector& Origin, struct FVector& RandomLocation, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.K2_GetRandomLocationInNavigableRadius // (NetRequest|Exec|Native|Event|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	bool IsNavigationBeingBuiltOrLocked(struct UObject* WorldContextObject); // Function NavigationSystem.NavigationSystemV1.IsNavigationBeingBuiltOrLocked // (Exec|Native|Event|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	bool IsNavigationBeingBuilt(struct UObject* WorldContextObject); // Function NavigationSystem.NavigationSystemV1.IsNavigationBeingBuilt // (NetReliableNetRequest|Native|Event|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	struct FVector GetRandomReachablePointInRadius(struct UObject* WorldContextObject, struct FVector& Origin, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetRandomReachablePointInRadius // (Net|NetReliableNetRequest|Exec|Event|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	struct FVector GetRandomPointInNavigableRadius(struct UObject* WorldContextObject, struct FVector& Origin, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetRandomPointInNavigableRadius // (Exec|Event|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	enum class ENavigationQueryResult GetPathLength(struct UObject* WorldContextObject, struct FVector& PathStart, struct FVector& PathEnd, float& PathLength, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetPathLength // (Net|NetReliableNetRequest|Exec|Native|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	enum class ENavigationQueryResult GetPathCost(struct UObject* WorldContextObject, struct FVector& PathStart, struct FVector& PathEnd, float& PathCost, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetPathCost // (NetReliableNetRequest|Native|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	struct UNavigationSystemV1* GetNavigationSystem(struct UObject* WorldContextObject); // Function NavigationSystem.NavigationSystemV1.GetNavigationSystem // (Net|NetReliableNative|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	struct UNavigationPath* FindPathToLocationSynchronously(struct UObject* WorldContextObject, struct FVector& PathStart, struct FVector& PathEnd, struct AActor* PathfindingContext, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.FindPathToLocationSynchronously // (NetReliableExec|NetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
	struct UNavigationPath* FindPathToActorSynchronously(struct UObject* WorldContextObject, struct FVector& PathStart, struct AActor* GoalActor, float TetherDistance, struct AActor* PathfindingContext, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.FindPathToActorSynchronously // (Net|NetReliableNetResponse|NetMulticast|UbergraphFunction|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c8440
};
...
struct ANavModifierVolume : AVolume {
	...
	void SetAreaClass(struct UNavArea* NewAreaClass); // Function NavigationSystem.NavModifierVolume.SetAreaClass // (NetReliableNetRequest|Exec|Event|MulticastDelegate|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c6280
};
...
struct ARecastNavMesh : ANavigationData {
	...
	bool K2_ReplaceAreaInTileBounds(struct FBox Bounds, struct UNavArea* OldArea, struct UNavArea* NewArea, bool ReplaceLinks); // Function NavigationSystem.RecastNavMesh.K2_ReplaceAreaInTileBounds // (Exec|Event|MulticastDelegate|Public|Private|HasOutParms|NetClient|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f317c5e00
};
