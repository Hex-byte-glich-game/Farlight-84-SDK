...
struct UHoudiniAssetComponent : UPrimitiveComponent {
	...
	struct TSet<struct UHoudiniAssetComponent*> DownstreamHoudiniAssets; // 0x828(0x50)
	struct FGuid ComponentGUID; // 0x878(0x10)
	struct FGuid HapiGUID; // 0x888(0x10)
	struct FString HapiAssetName; // 0x898(0x10)
	enum class EHoudiniAssetState AssetState; // 0x8a8(0x01)
	enum class EHoudiniAssetState DebugLastAssetState; // 0x8a9(0x01)
	enum class EHoudiniAssetStateResult AssetStateResult; // 0x8aa(0x01)
	char pad_8AB[0x1]; // 0x8ab(0x01)
	uint32_t SubAssetIndex; // 0x8ac(0x04)
	int32_t AssetCookCount; // 0x8b0(0x04)
	bool bHasBeenLoaded; // 0x8b4(0x01)
	bool bHasBeenDuplicated; // 0x8b5(0x01)
	bool bPendingDelete; // 0x8b6(0x01)
	bool bRecookRequested; // 0x8b7(0x01)
	bool bRebuildRequested; // 0x8b8(0x01)
	bool bEnableCooking; // 0x8b9(0x01)
	bool bForceNeedUpdate; // 0x8ba(0x01)
	bool bLastCookSuccess; // 0x8bb(0x01)
	bool bParameterDefinitionUpdateNeeded; // 0x8bc(0x01)
	bool bBlueprintStructureModified; // 0x8bd(0x01)
	bool bBlueprintModified; // 0x8be(0x01)
	char pad_8BF[0x1]; // 0x8bf(0x01)
	struct TArray<struct UHoudiniParameter*> Parameters; // 0x8c0(0x10)
	struct TArray<struct UHoudiniInput*> Inputs; // 0x8d0(0x10)
	struct TArray<struct UHoudiniOutput*> Outputs; // 0x8e0(0x10)
	struct TArray<struct FHoudiniBakedOutput> BakedOutputs; // 0x8f0(0x10)
	struct TArray<struct TWeakObjectPtr<struct AActor>> UntrackedOutputs; // 0x900(0x10)
	struct TArray<struct UHoudiniHandleComponent*> HandleComponents; // 0x910(0x10)
	bool bHasComponentTransformChanged; // 0x920(0x01)
	bool bFullyLoaded; // 0x921(0x01)
	char pad_922[0x6]; // 0x922(0x06)
	struct UHoudiniPDGAssetLink* PDGAssetLink; // 0x928(0x08)
	struct FTimerHandle RefineMeshesTimer; // 0x930(0x08)
	char pad_938[0x18]; // 0x938(0x18)
	bool bNoProxyMeshNextCookRequested; // 0x950(0x01)
	char pad_951[0x7]; // 0x951(0x07)
	struct TMap<struct UObject*, int32_t> InputPresets; // 0x958(0x50)
	bool bBakeAfterNextCook; // 0x9a8(0x01)
	char pad_9A9[0x7f]; // 0x9a9(0x7f)
	bool bCachedIsPreview; // 0xa28(0x01)
	char pad_A29[0xf]; // 0xa29(0x0f)
	double LastTickTime; // 0xa38(0x08)
	char pad_A40[0x20]; // 0xa40(0x20)
};

// Class HoudiniEngineRuntime.HoudiniAssetBlueprintComponent
// Size: 0xb50 (Inherited: 0xa60)
struct UHoudiniAssetBlueprintComponent : UHoudiniAssetComponent {
	char pad_A60[0x40]; // 0xa60(0x40)
	bool FauxBPProperty; // 0xaa0(0x01)
	bool bHoudiniAssetChanged; // 0xaa1(0x01)
	bool bUpdatedFromTemplate; // 0xaa2(0x01)
	bool bIsInBlueprintEditor; // 0xaa3(0x01)
	bool bCanDeleteHoudiniNodes; // 0xaa4(0x01)
	bool bHasRegisteredComponentTemplate; // 0xaa5(0x01)
	char pad_AA6[0xa]; // 0xaa6(0x0a)
	struct TMap<struct FHoudiniOutputObjectIdentifier, struct FGuid> CachedOutputNodes; // 0xab0(0x50)
	struct TMap<struct FGuid, struct FGuid> CachedInputNodes; // 0xb00(0x50)

	void SetToggleValueAt(struct FString Name, bool Value, int32_t Index); // Function HoudiniEngineRuntime.HoudiniAssetBlueprintComponent.SetToggleValueAt // (NetRequest|UbergraphFunction|MulticastDelegate|Public|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetFloatParameter(struct FString Name, float Value, int32_t Index); // Function HoudiniEngineRuntime.HoudiniAssetBlueprintComponent.SetFloatParameter // (NetReliableNetRequest|Exec|Native|Event|NetResponse|Static|NetMulticast|MulticastDelegate|Public|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f3144a3c0
	bool HasParameter(struct FString Name); // Function HoudiniEngineRuntime.HoudiniAssetBlueprintComponent.HasParameter // (Net|NetReliableExec|Native|Event|NetResponse|Static|NetMulticast|MulticastDelegate|Public|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f3144a3c0
};
...
struct UHoudiniInput : UObject {
	...
	float DefaultCurveOffset; // 0xd0(0x04)
	bool bAddRotAndScaleAttributesOnCurves; // 0xd4(0x01)
	...
	struct TArray<struct UHoudiniInputObject*> LandscapeSplinesInputObjects; // 0xf0(0x10)
	struct TArray<struct UHoudiniInputObject*> FoliageInputObjects; // 0x100(0x10)
	struct TArray<struct UHoudiniInputObject*> WorldSMCInputObjects; // 0x110(0x10)
	struct TArray<struct UHoudiniInputObject*> PointCloudInputObjects; // 0x120(0x10)
	struct TArray<struct UHoudiniInputObject*> WorldInputObjects; // 0x130(0x10)
	struct TArray<struct UHoudiniInputObject*> TextureInputObjects; // 0x140(0x10)
	struct TArray<struct AActor*> WorldInputBoundSelectorObjects; // 0x150(0x10)
	bool bIsWorldInputBoundSelector; // 0x160(0x01)
	bool bWorldInputBoundSelectorAutoUpdate; // 0x161(0x01)
	char pad_162[0x2]; // 0x162(0x02)
	float UnrealSplineResolution; // 0x164(0x04)
	struct TArray<struct UHoudiniInputObject*> SkeletalInputObjects; // 0x168(0x10)
	struct TArray<struct UHoudiniInputHoudiniSplineComponent*> LastInsertedInputs; // 0x178(0x10)
	struct TArray<struct UHoudiniInputObject*> LastUndoDeletedInputs; // 0x188(0x10)
	bool bUpdateInputLandscape; // 0x198(0x01)
	enum class EHoudiniLandscapeExportType LandscapeExportType; // 0x199(0x01)
	bool bLandscapeExportSelectionOnly; // 0x19a(0x01)
	bool bLandscapeAutoSelectComponent; // 0x19b(0x01)
	bool bLandscapeExportMaterials; // 0x19c(0x01)
	bool bLandscapeExportLighting; // 0x19d(0x01)
	bool bLandscapeExportNormalizedUVs; // 0x19e(0x01)
	bool bLandscapeExportTileUVs; // 0x19f(0x01)
	bool bCanDeleteHoudiniNodes; // 0x1a0(0x01)
	bool bAutoSelectInputType; // 0x1a1(0x01)
	bool bEnableSMCWorldFilter; // 0x1a2(0x01)
	bool bIsIncludeStaticMesh; // 0x1a3(0x01)
	bool bNeedSendModelMaterial; // 0x1a4(0x01)
	bool bNeedSendDataTableModel; // 0x1a5(0x01)
...
struct UHoudiniInputMeshComponent : UHoudiniInputSceneComponent {
	struct TSoftObjectPtr<UStaticMesh> StaticMesh; // 0xe0(0x28)
...
struct UHoudiniInputCameraComponent : UHoudiniInputSceneComponent {
	float FOV; // 0xe0(0x04)
	float AspectRatio; // 0xe4(0x04)
	bool bIsOrthographic; // 0xe8(0x01)
	char pad_E9[0x3]; // 0xe9(0x03)
	float OrthoWidth; // 0xec(0x04)
	float OrthoNearClipPlane; // 0xf0(0x04)
	float OrthoFarClipPlane; // 0xf4(0x04)
...
struct UHoudiniInputActor : UHoudiniInputObject {
	...
	struct TSet<struct TSoftObjectPtr<UObject>> ActorSceneComponents; // 0xb8(0x50)
	int32_t LastUpdateNumComponentsAdded; // 0x108(0x04)
	int32_t LastUpdateNumComponentsRemoved; // 0x10c(0x04)
};
...
struct UHoudiniInputLandscape : UHoudiniInputActor {
	struct FTransform CachedInputLandscapeTraqnsform; // 0x110(0x30)
	struct FHoudiniInputLandscapeTransferParams TransferParams; // 0x140(0xc8)
...
struct UHoudiniInputBrush : UHoudiniInputActor {
	struct TArray<struct FHoudiniBrushInfo> BrushesInfo; // 0x110(0x10)
	struct UModel* CombinedModel; // 0x120(0x08)
	bool bIgnoreInputObject; // 0x128(0x01)
	enum class EBrushType CachedInputBrushType; // 0x129(0x01)
...
struct UHoudiniSplineComponent : USceneComponent {
	...
	bool bIsHoudiniSplineVisible; // 0x362(0x01)
	enum class EHoudiniCurveType CurveType; // 0x363(0x01)
	enum class EHoudiniCurveMethod CurveMethod; // 0x364(0x01)
	bool bIsOutputCurve; // 0x365(0x01)
	bool bCookOnCurveChanged; // 0x366(0x01)
	char pad_367[0x229]; // 0x367(0x229)
	bool bHasChanged; // 0x590(0x01)
	bool bNeedsToTriggerUpdate; // 0x591(0x01)
	bool bIsInputCurve; // 0x592(0x01)
	bool bIsEditableOutputCurve; // 0x593(0x01)
	int32_t NodeId; // 0x594(0x04)
	struct FString PartName; // 0x598(0x10)
...
struct UHoudiniStaticMesh : UObject {
	...
	void SetVertexPosition(uint32_t InVertexIndex, struct FVector& InPosition); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetVertexPosition // (Net|NetRequest|Exec|Native|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455980
	void SetTriangleVertexVTangent(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FVector& InVTangent); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexVTangent // (Net|Exec|Native|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetTriangleVertexUV(uint32_t InTriangleIndex, char InTriangleVertexIndex, char InUVLayer, struct FVector2D& InUV); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexUV // (NetRequest|Native|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetTriangleVertexUTangent(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FVector& InUTangent); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexUTangent // (Native|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetTriangleVertexNormal(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FVector& InNormal); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexNormal // (Net|NetReliableExec|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetTriangleVertexIndices(uint32_t InTriangleIndex, struct FIntVector& InTriangleVertexIndices); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexIndices // (Exec|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetTriangleVertexColor(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FColor& InColor); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexColor // (NetRequest|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetTriangleMaterialID(uint32_t InTriangleIndex, int32_t InMaterialID); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleMaterialID // (Net|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetStaticMaterial(uint32_t InMaterialIndex, struct FStaticMaterial& InStaticMaterial); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetStaticMaterial // (Net|NetRequest|Exec|Native|Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetNumUVLayers(uint32_t InNumUVLayers); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetNumUVLayers // (Net|NetReliableExec|Native|Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetNumStaticMaterials(uint32_t InNumStaticMaterials); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetNumStaticMaterials // (Net|Exec|Native|Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetHasTangents(bool bInHasTangents); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasTangents // (NetReliableNetRequest|Native|Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetHasPerFaceMaterials(bool bInHasPerFaceMaterials); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasPerFaceMaterials // (NetRequest|Native|Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetHasNormals(bool bInHasNormals); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasNormals // (NetReliableNative|Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void SetHasColors(bool bInHasColors); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasColors // (Native|Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void Optimize(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.Optimize // (Net|NetReliableNetRequest|Exec|Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	bool IsValid(bool bInSkipVertexIndicesCheck); // Function HoudiniEngineRuntime.HoudiniStaticMesh.IsValid // (Net|NetRequest|Exec|Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void Initialize(uint32_t InNumVertices, uint32_t InNumTriangles, uint32_t InNumUVLayers, uint32_t InInitialNumStaticMaterials, bool bInHasNormals, bool bInHasTangents, bool bInHasColors, bool bInHasPerFaceMaterials); // Function HoudiniEngineRuntime.HoudiniStaticMesh.Initialize // (NetRequest|Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	bool HasTangents(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasTangents // (Net|NetReliableEvent|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	bool HasPerFaceMaterials(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasPerFaceMaterials // (Net|NetReliableEvent|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	bool HasNormals(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasNormals // (NetReliableEvent|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	bool HasColors(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasColors // (NetReliableEvent|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	struct TArray<struct FVector> GetVertexPositions(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexPositions // (Net|Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	struct TArray<struct FVector> GetVertexInstanceVTangents(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceVTangents // (Event|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	struct TArray<struct FVector2D> GetVertexInstanceUVs(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceUVs // (NetReliableNetRequest|Exec|Native|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	struct TArray<struct FVector> GetVertexInstanceUTangents(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceUTangents // (Net|NetRequest|Exec|Native|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	struct TArray<struct FVector> GetVertexInstanceNormals(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceNormals // (NetRequest|Exec|Native|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	struct TArray<struct FColor> GetVertexInstanceColors(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceColors // (NetReliableExec|Native|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	struct TArray<struct FIntVector> GetTriangleIndices(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetTriangleIndices // (Exec|Native|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	struct TArray<struct FStaticMaterial> GetStaticMaterials(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetStaticMaterials // (NetReliableNetRequest|Native|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	uint32_t GetNumVertices(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumVertices // (Net|NetRequest|Native|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	uint32_t GetNumVertexInstances(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumVertexInstances // (Net|NetRequest|Native|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	uint32_t GetNumUVLayers(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumUVLayers // (NetRequest|Native|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	uint32_t GetNumTriangles(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumTriangles // (NetRequest|Native|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	uint32_t GetNumStaticMaterials(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumStaticMaterials // (Net|NetReliableNative|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	int32_t GetMaterialIndex(struct FName InMaterialSlotName); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetMaterialIndex // (Net|Native|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	struct TArray<int32_t> GetMaterialIDsPerTriangle(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetMaterialIDsPerTriangle // (Net|NetReliableNetRequest|Exec|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	struct UMaterialInterface* GetMaterial(int32_t InMaterialIndex); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetMaterial // (NetRequest|Exec|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void CalculateTangents(bool bInComputeWeightedNormals); // Function HoudiniEngineRuntime.HoudiniStaticMesh.CalculateTangents // (NetReliableExec|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	void CalculateNormals(bool bInComputeWeightedNormals); // Function HoudiniEngineRuntime.HoudiniStaticMesh.CalculateNormals // (Exec|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	struct FBox CalcBounds(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.CalcBounds // (Net|NetReliableNetRequest|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
	uint32_t AddStaticMaterial(struct FStaticMaterial& InStaticMaterial); // Function HoudiniEngineRuntime.HoudiniStaticMesh.AddStaticMaterial // (NetReliableNetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455bc0
};
...
struct UHoudiniStaticMeshComponent : UMeshComponent {
	...
	void SetMesh(struct UHoudiniStaticMesh* InMesh); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.SetMesh // (NetReliableNetRequest|Exec|Event|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f314552c0
	void SetHoudiniIconVisible(bool bInHoudiniIconVisible); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.SetHoudiniIconVisible // (NetRequest|Exec|Event|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455980
	void NotifyMeshUpdated(); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.NotifyMeshUpdated // (Net|NetReliableExec|Event|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455980
	bool IsHoudiniIconVisible(); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.IsHoudiniIconVisible // (Net|NetReliableExec|Event|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455980
	struct UHoudiniStaticMesh* GetMesh(); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.GetMesh // (NetReliableExec|Event|NetResponse|NetMulticast|Private|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f31455980
};
