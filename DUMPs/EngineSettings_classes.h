...
struct UGameMapsSettings : UObject {
	...
	void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer); // Function EngineSettings.GameMapsSettings.SetSkipAssigningGamepadToPlayer1 // (Net|Exec|NetResponse|Static|NetMulticast|UbergraphFunction|Public|NetServer|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f316e40c0
	bool GetSkipAssigningGamepadToPlayer1(); // Function EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1 // (Exec|NetResponse|Static|NetMulticast|UbergraphFunction|Public|NetServer|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f316de2c0
	struct UGameMapsSettings* GetGameMapsSettings(); // Function EngineSettings.GameMapsSettings.GetGameMapsSettings // (Exec|NetResponse|Static|NetMulticast|UbergraphFunction|Public|NetServer|DLLImport|BlueprintCallable|BlueprintEvent|NetValidate) // @ game+0xffff822f316de2c0
};
